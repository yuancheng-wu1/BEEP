    ...
    mainPanel(
      ...
      tabsetPanel(
        ...
        tabPanel(
          ...
          p("Statistics are calculated from the same filtered data shown in the plot."),
        ...
        tabPanel(
          ...
          p(
            ...
            code("dat"),
            ". Change the object name above if needed."
          ),
...
server <- function(input, output, session) {
  ...
  plot_object <- reactive({
    ...
    # ---------- bar plot ----------
      ...
      validate(
        need(has_x, "Bar plot currently requires an X variable.")
      )
